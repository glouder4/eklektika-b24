...
$secret = (string)(getenv('EKLEKTIKA_SYNC_INBOUND_SECRET') ?: '');
if ($secret === '') {
    $settingsPath = rtrim((string)($_SERVER['DOCUMENT_ROOT'] ?? ''), '/') . '/local/sync/site_sync_settings.local.php';
